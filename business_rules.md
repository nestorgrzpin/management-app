...
- `fase`: Una de las 6 fases (1-6) o etapa (Planeación, Ejecución, Cierre)
- `presupuesto`: Monto en millones
...
- `estimated_duration_days`: Duración estimada
- `responsible_user_id`: ID del responsable
- `progress_percentage`: Porcentaje de avance (0-100)
- `dependencies`: JSON array con IDs de actividades dependientes

## Validaciones

1. Un proyecto en "Planeación" solo puede contener actividades de Fases 1-2
2. Un proyecto en "Ejecución" solo puede contener actividades de Fases 3-5
3. Un proyecto en "Cierre" solo puede contener actividades de Fase 6
4. Las actividades respetan las dependencias definidas en el documento de plantilla
5. La duración no puede ser negativa
6. El presupuesto es requerido y debe ser > 0
